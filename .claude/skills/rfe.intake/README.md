...
|--|--|--|
| **Built for** | RFE **recipient** | RFE **author** |
| **Typical user** | PM who received a field or customer RFE | PM who wrote the RFE and wants it improved |
...
The skill fetches RFE content from Jira. Two options — configure one:
...
Plain-English distillation of what the submitter is asking for. Written for a PM who hasn't read the RFE — strips jargon, surfaces the real user need.

### PM action list

Gaps found in the assessment → concrete investigative tasks. Where relevant, suggests [Tailwind](https://gitlab.cee.redhat.com/tailwind/tailwind) skills that might help:
...
Suggestions are framed as "might help — use your judgment." Also includes a reminder to check your team's strategy backlog before acting.
